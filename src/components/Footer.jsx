...
const translations = {
  ge: {
    ...
    id_code: "ს/კ: 01008056499",
    built_by: "საიტი შექმნილია",
    developer: "Amiko Nebulishvili-ს მიერ"
  },
  en: {
    ...
    id_code: "ID Code: 01008056499",
    built_by: "Site built by",
    developer: "Amiko Nebulishvili"
  },
  ru: { 
    ...
    id_code: "И/К: 01008056499",
    built_by: "Сайт создан",
    developer: "Amiko Nebulishvili"
  }
};
...
const Footer = () => {
  ...
  return (
    <footer className="w-full font-sans text-gray-600 text-sm pb-10"> 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div className="flex items-start gap-4">
                    <img src="/fav.jpg" alt="Logo" className="w-20 h-20 border border-gray-200" />
      ...
      {/* --- Copyright & Credits --- */}
      <div className="bg-white py-8 border-t border-gray-200 text-center flex flex-col items-center justify-center">
         <h3 className="font-serif text-xl tracking-[0.2em] mb-2 text-black">N.T.Style</h3>
         
         {/* საავტორო უფლებები და საიდენტიფიკაციო კოდი */}
         <p className="text-[10px] text-gray-400 uppercase tracking-widest mb-1">
           © {new Date().getFullYear()} N.T.Style. {t.all_rights} | {t.id_code}
         </p>
         ...
         <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-2">
           {t.built_by}{' '}
           <a 
             href="https://www.linkedin.com/in/amiko-nebulishvili/" 
             target="_blank" 
             rel="noopener noreferrer" 
             className="text-gray-500 hover:text-black hover:underline font-bold transition-colors"
           >
             {t.developer}
           </a>
         </p>
